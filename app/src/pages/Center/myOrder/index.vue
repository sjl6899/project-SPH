        ...
        >
          ...
          <tbody>
            <tr v-for="(cart,index) in order.orderDetailList" :key="cart.id"> 
              ...
              <td :rowspan="order.orderDetailList.lerght" v-if="index==0" width="8%" class="center">{{ order.consignee }}</td>
              <td :rowspan="order.orderDetailList.lerght" v-if="index==0" width="13%" class="center">
                <ul class="unstyled">
                  <li>总金额¥{{ order.totalAmount }}.00</li>
                  <li>在线支付</li>
                </ul>
              </td>
              <td :rowspan="order.orderDetailList.lerght" v-if="index==0" width="8%" class="center">
